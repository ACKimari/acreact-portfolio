...
import ProjectThree from '../Assets/capstone-thumbnail.jpg';

export default function Portfolio() {
    return (
        <div>
            <h2 id="projects">My Work/Projects</h2>
            <img href="https://magnetmoss.github.io/Lets-Settle-It/" src={ ProjectOne } alt="Let's Settle It application page" style={{ width: "100%" }}/>
            ...
            <img src={ ProjectTwo } alt="light in a crafted masonjar" style={{ width: "100%" }}/>
            ...
            <img src={ ProjectThree } alt="light in a crafted masonjar" style={{ width: "100%" }}/>
            <h3>Project 3</h3>
